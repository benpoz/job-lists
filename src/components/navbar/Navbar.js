        ...
        <nav className="font-sans flex flex-col text-center content-center sm:flex-row sm:text-left sm:justify-between py-2 px-6 bg-white shadow sm:items-baseline w-full">
            <div className="mb-2 sm:mb-0 flex flex-row">
                <div className="h-10 w-10 self-center mr-2">
                    <img alt="logo" className="h-10 w-10 self-center" src="https://image.similarpng.com/very-thumbnail/2021/07/Cartoon-sheep-illustration-on-transparent-background-PNG.png" />
                </div>
                <div>
